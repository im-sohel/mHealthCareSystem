...
public class Patient_login extends AppCompatActivity implements View.OnClickListener{
   ...
   //private static final String URL="http://192.168.43.179/mhcsystem/login.php";
    private static final String URL="https://mhcs.000webhostapp.com/mhcsystem/login.php";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.reg:
                startActivity(new Intent(getApplicationContext(),Patient_register.class));
                break;
            case R.id.login:
